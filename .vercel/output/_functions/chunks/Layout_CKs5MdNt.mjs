import { a as createComponent, d as addAttribute, b as renderTemplate, v as defineScriptVars, c as createAstro, r as renderComponent, F as Fragment, u as unescapeHTML, s as spreadAttributes, h as renderScript, g as renderHead, e as renderSlot } from './astro/server_e083InG_.mjs';
import 'kleur/colors';
/* empty css                                 */
import { f as getAsset, U as UI, b as getCanonical, I as I18N, S as SITE, M as METADATA, h as ANALYTICS } from './permalinks_OHe_PGpA.mjs';
import 'clsx';
import merge from 'lodash.merge';
import { escape } from 'html-escaper';
import { c as getImage } from './_astro_assets_Bu240PC6.mjs';
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/components/common/CommonMeta.astro", void 0);

const favIconSvg = "/_astro/favicon.Cx96Tg-l.ico";

const appleTouchIcon = new Proxy({"src":"/_astro/apple-touch-icon.DqsVvTXu.png","width":2000,"height":2000,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/dennistroeger/cursor-apps/dt_hp/src/assets/favicons/apple-touch-icon.png";
							}
...
const $$Favicons = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<link rel="shortcut icon"${addAttribute(favIconSvg, "href")}><link rel="icon" type="image/svg+xml"${addAttribute(favIconSvg.src, "href")}><link rel="mask-icon"${addAttribute(favIconSvg.src, "href")} color="#8D46E7"><link rel="apple-touch-icon" sizes="180x180"${addAttribute(appleTouchIcon.src, "href")}>`;
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/components/Favicons.astro", void 0);
...
const $$CustomStyles = createComponent(($$result, $$props, $$slots) => {
  ...
  :root {
    ...
    --aw-color-primary: #7a4eff;
    --aw-color-secondary: #37f3ca;
    --aw-color-accent: #3ab3e2;

    --aw-color-text-heading: rgb(0 0 0);
    --aw-color-text-default: rgb(0 0 0);
    --aw-color-text-muted: rgb(0 0 0);
    --aw-color-bg-page: rgb(255 255 255);
    --aw-color-ul: rgb(0 0 0);
    --aw-color-li: rgb(51 51 51);

    --aw-color-bg-page-dark: rgb(3 6 32);

    ::selection {
      background-color: #37f3ca;
      color: black;
    }
  }
  ...
  .dark {
    ...
    --aw-color-text-muted: #ffffff;
    --aw-color-bg-page: rgb(3 6 32);
    --aw-color-ul: rgb(255 255 255);
    --aw-color-li: rgb(229 229 229);
  ...
  ul {
    color: var(--aw-color-ul);
  }

  li {
    color: var(--aw-color-li);
  }
</style>`;
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/components/CustomStyles.astro", void 0);
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/components/common/ApplyColorMode.astro", void 0);
...
const $$Astro$4 = createAstro("https://www.dennistroeger.com");
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);
...
const load = async function() {
  let images = void 0;
  try {
    images = /* #__PURE__ */ Object.assign({"/src/assets/images/Dennis Troeger.png": () => import('./Dennis Troeger_CA2gdnFf.mjs'),"/src/assets/images/app-store.png": () => import('./app-store_DcfmyteI.mjs'),"/src/assets/images/default.png": () => import('./default_COgmm6-P.mjs'),"/src/assets/images/dennis troeger italy.jpg": () => import('./dennis troeger italy_JuW2_AFs.mjs'),"/src/assets/images/feature_images/dennistroeger_wasted_my_life.png": () => import('./dennistroeger_wasted_my_life_B56U-VIJ.mjs'),"/src/assets/images/feature_images/find_purpose_with_ai.png": () => import('./find_purpose_with_ai_DsPWdsa0.mjs'),"/src/assets/images/feature_images/image_0.png": () => import('./image_0_BONgGM7_.mjs'),"/src/assets/images/feature_images/image_1.png": () => import('./image_1_DMcZXSRN.mjs'),"/src/assets/images/feature_images/image_10.png": () => import('./image_10_bguNnUOt.mjs'),"/src/assets/images/feature_images/image_11.png": () => import('./image_11_BUMVYQMC.mjs'),"/src/assets/images/feature_images/image_12.png": () => import('./image_12_Dppdncoz.mjs'),"/src/assets/images/feature_images/image_13.png": () => import('./image_13_CgkdzUNg.mjs'),"/src/assets/images/feature_images/image_14.png": () => import('./image_14_DWT6OqFA.mjs'),"/src/assets/images/feature_images/image_15.png": () => import('./image_15_CN9gdW3Z.mjs'),"/src/assets/images/feature_images/image_16.png": () => import('./image_16_B40f7AyQ.mjs'),"/src/assets/images/feature_images/image_2.png": () => import('./image_2_DIUqv_OD.mjs'),"/src/assets/images/feature_images/image_3.png": () => import('./image_3_DO4mRmIa.mjs'),"/src/assets/images/feature_images/image_4.png": () => import('./image_4_CouJuQzJ.mjs'),"/src/assets/images/feature_images/image_5.png": () => import('./image_5_7LHNuv5A.mjs'),"/src/assets/images/feature_images/image_6.png": () => import('./image_6_CjDf-Z4W.mjs'),"/src/assets/images/feature_images/image_7.png": () => import('./image_7_DHS8alsr.mjs'),"/src/assets/images/feature_images/image_8.png": () => import('./image_8_Ch-igxVl.mjs'),"/src/assets/images/feature_images/image_9.png": () => import('./image_9_Cc0zZgC2.mjs'),"/src/assets/images/feature_images/overcome_imposter_syndrome.png": () => import('./overcome_imposter_syndrome_C82hFcDS.mjs'),"/src/assets/images/google-play.png": () => import('./google-play_wdG_Sdv3.mjs'),"/src/assets/images/hero-image.png": () => import('./hero-image_CefUPGHp.mjs'),"/src/assets/images/logo.png": () => import('./logo_BY9my3XR.mjs'),"/src/assets/images/logo_invert.png": () => import('./logo_invert_Bp_xqD0T.mjs')});
  } catch (error) {
  }
  return images;
};
...
const $$Astro$3 = createAstro("https://www.dennistroeger.com");
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/components/common/Metadata.astro", void 0);
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/components/common/SiteVerification.astro", void 0);

var __freeze$1 = Object.freeze;
var __defProp$1 = Object.defineProperty;
var __template$1 = (cooked, raw) => __freeze$1(__defProp$1(cooked, "raw", { value: __freeze$1(cooked.slice()) }));
var _a$1;
const $$Astro$2 = createAstro("https://www.dennistroeger.com");
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/node_modules/@astrolib/analytics/src/GoogleAnalytics.astro", void 0);
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/components/common/Analytics.astro", void 0);
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/components/common/BasicScripts.astro", void 0);
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/Users/dennistroeger/cursor-apps/dt_hp/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/dennistroeger/cursor-apps/dt_hp/node_modules/astro/components/ClientRouter.astro", void 0);
...
}, "/Users/dennistroeger/cursor-apps/dt_hp/src/layouts/Layout.astro", void 0);
